...
public class PastaProgressBarUi extends BasicProgressBarUI {
...
//        g.setPaint(baseRainbowPaint);
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) PastaIcons.PASTA_ICON) : ((ScalableIcon) PastaIcons.RPASTA_ICON) ;
//        if (velocity < 0) {
...
//        g2.setColor(progressBar.getForeground());
        ...
        PastaIcons.PASTA_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
